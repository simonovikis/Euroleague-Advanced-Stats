...
def compute_lineup_stats(
    ...
    # Group rows by their (home_team, away_team) pair so that each game's
    # lineup context is respected. This prevents opponent contamination
    # when a team alternates between home and away across a season.
    per_lineup: dict[frozenset, dict] = {}  # lineup → aggregated stats
